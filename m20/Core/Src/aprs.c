...
static uint8_t
encode_comment_telemetry(APRSPacket Packet,
                         char* buff) { // Comment field telemetry
	                                   // https://github.com/projecthorus/sondehub-aprs-gateway/blob/main/sondehub_aprs_gw/comment_telemetry.py#L242
	uint8_t cnt = 0;
