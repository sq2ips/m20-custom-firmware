 ...
 * horus_v3.c
 * By Mark VK5QI
 * Sourced from https://github.com/darksidelemm/rs41-nfw/blob/main/fw/fw-files/rs41-nfw/HorusBinaryV3.c
		...
		switch (pVal->kind) {
			case horusStr_PRESENT:
				...
				for (i1 = 0; (i1 < (int)nStringLength) && ret; i1++) {
					static byte allowedCharSet[] = {0x20, 0x2B, 0x2D, 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38,
					                                0x39, 0x3D, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x4B, 0x4C,
		...
		if (ret) {
			...
			if (ret) {
				...
				if (pVal->exist.name) {
					...
					for (i1 = 0; (i1 < (int)nStringLength) && ret; i1++) {
						static byte allowedCharSet[] = {0x2D, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x61, 0x62,
...
flag horusGnssPowerSaveState_IsConstraintValid(const horusGnssPowerSaveState* pVal, int* pErrCode) {
	flag ret = TRUE;
	ret = ((((((((((((*(pVal)) == horuspsmNotActive)) || (((*(pVal)) == horusenabled)))) || (((*(pVal)) == horusacquisition)))) ||
	           (((*(pVal)) == horustracking)))) ||
	         (((*(pVal)) == horusoptimised)))) ||
	       (((*(pVal)) == horusinactive)));
...
flag horusTelemetry_velocityHorizontalKilometersPerHour_IsConstraintValid(const horusTelemetry_velocityHorizontalKilometersPerHour* pVal,
                                                                          int* pErrCode) {
	flag ret = TRUE;
	ret = ((*(pVal)) <= 512UL);
						...
						if (ret) {
							...
							if (ret) {
								if (pVal->exist.velocityHorizontalKilometersPerHour) {
									ret = horusTelemetry_velocityHorizontalKilometersPerHour_IsConstraintValid(
									    (&(pVal->velocityHorizontalKilometersPerHour)), pErrCode);
								}
								if (ret) {
									...
									if (ret) {
										if (pVal->exist.ascentRateCentimetersPerSecond) {
											ret = horusTelemetry_ascentRateCentimetersPerSecond_IsConstraintValid(
											    (&(pVal->ascentRateCentimetersPerSecond)), pErrCode);
										}
										if (ret) {
											...
											if (ret) {
												...
												if (ret) {
													if (pVal->exist.humidityPercentage) {
														ret = horusTelemetry_humidityPercentage_IsConstraintValid((&(pVal->humidityPercentage)),
														                                                          pErrCode);
													}
													if (ret) {
														...
														if (ret) {
															...
															if (ret) {
																if (pVal->exist.gnssPowerSaveState) {
																	ret = horusGnssPowerSaveState_IsConstraintValid((&(pVal->gnssPowerSaveState)),
																	                                                pErrCode);
																}
																if (ret) {
																	if (pVal->exist.customData) {
																		ret = horusTelemetry_customData_IsConstraintValid((&(pVal->customData)),
																		                                                  pErrCode);
																	}
																} /*COVERAGE_IGNORE*/
															} /*COVERAGE_IGNORE*/
														...
														if (ret) {
															...
															for (i1 = 0; (i1 < (int)nStringLength) && ret; i1++) {
																static byte allowedCharSet[] = {
																    0x2D, 0x2F, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x41,
															...
															if (ret) {
																...
																BitStream_EncodeConstraintPosWholeNumber(
																    pBitStrm, (asn1SccUint)(pVal->sequenceNumber), 0, 65535);
																if (ret) {
																	/*Encode timeOfDaySeconds */
																	BitStream_EncodeConstraintWholeNumber(
																	    pBitStrm, (asn1SccSint)(pVal->timeOfDaySeconds), -1, 86400);
																	if (ret) {
																		/*Encode latitude */
																		BitStream_EncodeConstraintWholeNumber(pBitStrm, (asn1SccSint)(pVal->latitude),
																		                                      -9000000, 9000000);
																		if (ret) {
																			/*Encode longitude */
																			BitStream_EncodeConstraintWholeNumber(
																			    pBitStrm, (asn1SccSint)(pVal->longitude), -18000000, 18000000);
																			if (ret) {
																				/*Encode altitudeMeters */
																				BitStream_EncodeConstraintWholeNumber(
																				    pBitStrm, (asn1SccSint)(pVal->altitudeMeters), -1000, 50000);
																				if (ret) {
																					/*Encode extraSensors */
																					if (pVal->exist.extraSensors) {
																						ret = horusAdditionalSensors_Encode(
																						    (&(pVal->extraSensors)), pBitStrm, pErrCode, FALSE);
																					}
																					if (ret) {
																						...
																						if (pVal->exist.velocityHorizontalKilometersPerHour) {
																							BitStream_EncodeConstraintPosWholeNumber(
																							    pBitStrm,
																							    (asn1SccUint)(pVal->velocityHorizontalKilometersPerHour),
																							    0, 512);
																						}
																						if (ret) {
																							...
																							if (pVal->exist.gnssSatellitesVisible) {
																								BitStream_EncodeConstraintPosWholeNumber(
																								    pBitStrm,
																								    (asn1SccUint)(pVal->gnssSatellitesVisible), 0,
																								    31);
																							}
																							if (ret) {
																								...
																								if (pVal->exist.ascentRateCentimetersPerSecond) {
																									BitStream_EncodeConstraintWholeNumber(
																									    pBitStrm,
																									    (asn1SccSint)(pVal->ascentRateCentimetersPerSecond),
																									    -32767, 32767);
																								}
																								if (ret) {
																									...
																									if (pVal->exist.pressurehPa_x10) {
																										BitStream_EncodeConstraintPosWholeNumber(
																										    pBitStrm,
																										    (asn1SccUint)(pVal->pressurehPa_x10), 0,
																										    12000);
																									}
																									if (ret) {
																										/*Encode temperatureCelsius_x10 */
																										if (pVal->exist.temperatureCelsius_x10) {
																											ret = horusTemperatureSensors_Encode(
																											    (&(pVal->temperatureCelsius_x10)),
																											    pBitStrm, pErrCode, FALSE);
																										}
																										if (ret) {
																											...
																											if (pVal->exist.humidityPercentage) {
																												BitStream_EncodeConstraintPosWholeNumber(
																												    pBitStrm,
																												    (asn1SccUint)(pVal->humidityPercentage),
																												    0, 100);
																											}
																											if (ret) {
																												/*Encode milliVolts */
																												...
																												if (ret) {
																													...
																													if (ret) {
																														...
																														if (pVal->exist
																														        .gnssPowerSaveState) {
																															ret = horusGnssPowerSaveState_Encode(
																															    (&(pVal->gnssPowerSaveState)),
																															    pBitStrm, pErrCode,
																															    FALSE);
																														}
																														if (ret) {
																															...
																															if (pVal->exist
																																...
																																BitStream_EncodeConstraintWholeNumber(
																																    ...
																																    pVal->customData
																																        .nCount,
																																    0, 255);
																																ret = BitStream_EncodeOctetString_no_length(
																																    pBitStrm,
																																    pVal->customData
																																        .arr,
																																    pVal->customData
												...
												if (ret) {
													...
													if (ret) {
														...
														if (ret) {
															...
															ret = BitStream_DecodeConstraintPosWholeNumberUInt16(pBitStrm, (&(pVal->sequenceNumber)),
															                                                     0, 65535);
															*pErrCode = ret ? 0 : ERR_UPER_DECODE_TELEMETRY_SEQUENCENUMBER;
															if (ret) {
																/*Decode timeOfDaySeconds */
																ret = BitStream_DecodeConstraintWholeNumberInt32(
																    pBitStrm, (&(pVal->timeOfDaySeconds)), -1, 86400);
																*pErrCode = ret ? 0 : ERR_UPER_DECODE_TELEMETRY_TIMEOFDAYSECONDS;
																if (ret) {
																	/*Decode latitude */
																	ret = BitStream_DecodeConstraintWholeNumberInt32(pBitStrm, (&(pVal->latitude)),
																	                                                 -9000000, 9000000);
																	*pErrCode = ret ? 0 : ERR_UPER_DECODE_TELEMETRY_LATITUDE;
																	if (ret) {
																		/*Decode longitude */
																		ret = BitStream_DecodeConstraintWholeNumberInt32(
																		    pBitStrm, (&(pVal->longitude)), -18000000, 18000000);
																		*pErrCode = ret ? 0 : ERR_UPER_DECODE_TELEMETRY_LONGITUDE;
																		if (ret) {
																			/*Decode altitudeMeters */
																			ret = BitStream_DecodeConstraintWholeNumberInt32(
																			    pBitStrm, (&(pVal->altitudeMeters)), -1000, 50000);
																			*pErrCode = ret ? 0 : ERR_UPER_DECODE_TELEMETRY_ALTITUDEMETERS;
																			if (ret) {
																				/*Decode extraSensors */
																				if (pVal->exist.extraSensors) {
																					ret = horusAdditionalSensors_Decode((&(pVal->extraSensors)),
																					                                    pBitStrm, pErrCode);
																				}
																				if (ret) {
																					/*Decode velocityHorizontalKilometersPerHour */
																					if (pVal->exist.velocityHorizontalKilometersPerHour) {
																						ret = BitStream_DecodeConstraintPosWholeNumberUInt16(
																						    pBitStrm, (&(pVal->velocityHorizontalKilometersPerHour)),
																						    0, 512);
																						*pErrCode =
																						    ret ? 0
																						        : ERR_UPER_DECODE_TELEMETRY_VELOCITYHORIZONTALKILOMETERSPERHOUR;
																					}
																					if (ret) {
																						/*Decode gnssSatellitesVisible */
																						if (pVal->exist.gnssSatellitesVisible) {
																							ret = BitStream_DecodeConstraintPosWholeNumberUInt8(
																							    pBitStrm, (&(pVal->gnssSatellitesVisible)), 0, 31);
																							*pErrCode =
																							    ret ? 0
																							        : ERR_UPER_DECODE_TELEMETRY_GNSSSATELLITESVISIBLE;
																						}
																						if (ret) {
																							/*Decode ascentRateCentimetersPerSecond */
																							if (pVal->exist.ascentRateCentimetersPerSecond) {
																								ret = BitStream_DecodeConstraintWholeNumberInt16(
																								    pBitStrm,
																								    (&(pVal->ascentRateCentimetersPerSecond)), -32767,
																								    32767);
																								*pErrCode =
																								    ret ? 0
																								        : ERR_UPER_DECODE_TELEMETRY_ASCENTRATECENTIMETERSPERSECOND;
																							}
																							if (ret) {
																								...
																								if (pVal->exist.pressurehPa_x10) {
																									ret =
																									    BitStream_DecodeConstraintPosWholeNumberUInt16(
																									        pBitStrm, (&(pVal->pressurehPa_x10)), 0,
																									        12000);
																									*pErrCode =
																									    ret ? 0
																									        : ERR_UPER_DECODE_TELEMETRY_PRESSUREHPA_X10;
																								}
																								if (ret) {
																									/*Decode temperatureCelsius_x10 */
																									if (pVal->exist.temperatureCelsius_x10) {
																										ret = horusTemperatureSensors_Decode(
																										    (&(pVal->temperatureCelsius_x10)),
																										    pBitStrm, pErrCode);
																									}
																									if (ret) {
																										...
																										if (pVal->exist.humidityPercentage) {
																											ret =
																											    BitStream_DecodeConstraintPosWholeNumberUInt8(
																											        pBitStrm,
																											        (&(pVal->humidityPercentage)), 0,
																											        100);
																											*pErrCode =
																											    ret ? 0
																											        : ERR_UPER_DECODE_TELEMETRY_HUMIDITYPERCENTAGE;
																										}
																										if (ret) {
																											/*Decode milliVolts */
																											if (pVal->exist.milliVolts) {
																												ret = horusMilliVoltSensors_Decode(
																												    (&(pVal->milliVolts)), pBitStrm,
																												    pErrCode);
																											}
																											if (ret) {
																												/*Decode counts */
																												if (pVal->exist.counts) {
																													...
																													*pErrCode =
																													    ret ? 0
																													        : ERR_UPER_DECODE_TELEMETRY_COUNTS;
																													pVal->counts.nCount =
																													    (long)nCount;
																													for (i1 = 0;
																													     (i1 <
																													      (int)pVal->counts.nCount) &&
																													     ret;
																													     i1++) {
																														ret =
																														...
																														*pErrCode =
																														    ret ? 0
																														        : ERR_UPER_DECODE_TELEMETRY_COUNTS_ELM;
																													}
																												}
																												if (ret) {
																													...
																													if (pVal->exist
																													        .gnssPowerSaveState) {
																														ret = horusGnssPowerSaveState_Decode(
																														    (&(pVal->gnssPowerSaveState)),
																														    pBitStrm, pErrCode);
																													}
																													if (ret) {
																														...
																														if (pVal->exist.customData) {
																															...
																															*pErrCode =
																															    ret ? 0
																															        : ERR_UPER_DECODE_TELEMETRY_CUSTOMDATA;
																															pVal->customData.nCount =
																															    (long)nCount;
																															ret =
