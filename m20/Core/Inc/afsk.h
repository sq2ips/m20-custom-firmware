...
#define AFSK_PWM_TIM_ARR                                                                                                                             \
	255 // Must be max value from sine lookup table. Generates PWM frequency and sampling interrupt (therefore it's also sample rate): 12MHz / (255+1)
	    // Hz = 46.875kHz
